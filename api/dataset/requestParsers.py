...
NewDatasetRequestParser.add_argument("host", type=str, )
NewDatasetRequestParser.add_argument("port", type=str, )
NewDatasetRequestParser.add_argument("user", type=str, )
NewDatasetRequestParser.add_argument("password", type=str, )
NewDatasetRequestParser.add_argument("database", type=str, )
NewDatasetRequestParser.add_argument("query", type=str, )
