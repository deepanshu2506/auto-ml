...
class myGraph(object):
    def __init__(self, node_num):
        ...
        self.dis = self.G[:]
        self.sim = [
            [0 for i in range(node_num)] for j in range(node_num)
    ...
    def getCost(self, node1, node2):
        ...
        if (
            node1.table.describe == node2.table.describe
            and node1.x_name == node2.x_name
        ):
            if node1.y_name == node2.y_name and node1.chart == node2.chart:
                return 0.02
            elif node1.y_name == node2.y_name:
                if node1.chart == ChartType.pie and node2.chart == ChartType.bar:
                    return 0.03
                if node1.chart == ChartType.pie and node2.chart == ChartType.line:
                    return 0.02
                if node1.chart == ChartType.pie and node2.chart == ChartType.scatter:
                    return 0.04
                if node1.chart == ChartType.bar and node2.chart == ChartType.line:
                    return 0.04
                if node1.chart == ChartType.bar and node2.chart == ChartType.scatter:
                    return 0.02
                if node1.chart == ChartType.line and node2.chart == ChartType.scatter:
                    return 0.03
        ...
        # transformEditOps  ->    p3 (BIN)
            ...
            node1.table.describe == ""
            and node2.table.describe[0:3] == "BIN"
            and node1.x_name == node2.x_name[0 : len(node1.x_name)]
            and node1.y_name == node2.y_name[4:-1]
            and node1.chart == node2.chart
        ):
            return 0.62
        elif (
            node2.table.describe == ""
            and node1.table.describe[0:3] == "BIN"
            and node2.x_name == node1.x_name[0 : len(node2.x_name)]
            and node2.y_name == node1.y_name[4:-1]
            and node1.chart == node2.chart
        ):
            return 0.62
        # encodingEditOps   ->   p1 (change x) and p2 (change y)
            ...
            node1.table.describe2 == node2.table.describe
            and node1.table.describe1[0:5] == "GROUP"
            and node1.x_name == node2.x_name
            and node1.chart == node2.chart
        ):  # add z
            t1, t2 = node1.y_name, node2.y_name
            ...
            node2.table.describe2 == node1.table.describe
            and node2.table.describe1[0:5] == "GROUP"
            and node1.x_name == node2.x_name
            and node1.chart == node2.chart
        ):  # add z
            t1, t2 = node1.y_name, node2.y_name
    ...
    def addNode(self, node):
        ...
        for i in range(self.node_num):
            self.G[i][self.node_num] = self.G[self.node_num][i] = self.dis[i][
                self.node_num
            ] = self.dis[self.node_num][i] = self.getCost(self.nodes[i], node)
        self.node_num += 1
