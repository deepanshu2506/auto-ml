...
from lib.auto_imputer import DecisionTreeImputer,BayesianRidgeImputer,MedianImputer,KNeighborsRegressorImputer,ExtraTreesRegressorImputer,MeanImputer
...
class ImputationService:
    ...
    def impute_col(self, dataset_id, col_name, impute_type, value=None):
        ...
        dataset: Dataset = self.datasetService.find_by_id(dataset_id, get_jwt_identity())
    ...
    def impute_dataset(self, dataset_id, target_col_name):
        ...
        dataframe_imputed,impute_type=AutoImputerFactory.get_auto_imputer(features,dataframe_encoded, loaded_model=self.imputer_model)
